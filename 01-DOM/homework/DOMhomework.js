...
document.querySelector("#createdBy").innerHTML = "Aplicación creada por Amaya Claudio"
//let spn = document.querySelector("#createdBy");
//spn.innerHTML = spn.innerHTML + " Amaya Claudio";
...
function buildToDo(todo, index) {
  ...
  if(todo.complete){
    toDoText.className = "completeText"; //toDoShell.setAttribute("class", "completeText");
  }
